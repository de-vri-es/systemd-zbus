...
trait Manager {
    ...
    fn disable_unit_files(&self, files: &[&str], runtime: bool) -> zbus::Result<Vec<Change>>;
    ...
    /// GetJobAfter method
    fn get_job_after(&self, id: u32) -> zbus::Result<Vec<Job>>;

    /// GetJobBefore method
    fn get_job_before(&self, id: u32) -> zbus::Result<Vec<Job>>;
    ...
    /// ListUnits method
    fn list_units(&self) -> zbus::Result<Vec<Unit>>;

    /// ListUnitsByNames method
    fn list_units_by_names(&self, names: &[&str]) -> zbus::Result<Vec<Unit>>;
    ...
    fn list_units_filtered(&self, states: &[LoadState]) -> zbus::Result<Vec<Unit>>;
    ...
    /// ReloadUnit method
    fn reload_unit(&self, name: &str, mode: Mode) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;
    ...
    /// RestartUnit method
    fn restart_unit(&self, name: &str, mode: Mode)
        -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

    /// RevertUnitFiles method
    fn revert_unit_files(&self, files: &[&str]) -> zbus::Result<Vec<Change>>;

    /// SetDefaultTarget method
    fn set_default_target(&self, name: &str, force: bool) -> zbus::Result<Vec<Change>>;
    ...
    fn set_show_status(&self, mode: Mode) -> zbus::Result<()>;
    ...
    /// StartUnit method
    fn start_unit(&self, name: &str, mode: Mode) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;
    ...
    /// StopUnit method
    fn stop_unit(&self, name: &str, mode: Mode) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;
    ...
    fn unmask_unit_files(&self, files: &[&str], runtime: bool) -> zbus::Result<Vec<Change>>;
