//! # DBus interface proxies for: `org.freedesktop.systemd1.Service`
//!
...
trait Service {
    ...
    #[dbus_proxy(property)]
    fn exec_condition(&self) -> zbus::Result<Vec<Exec>>;
    ...
    /// ExecReload property
    #[dbus_proxy(property)]
    fn exec_reload(&self) -> zbus::Result<Vec<Exec>>;
    ...
    /// ExecStart property
    #[dbus_proxy(property)]
    fn exec_start(&self) -> zbus::Result<Vec<Exec>>;
    ...
    /// ExecStop property
    #[dbus_proxy(property)]
    fn exec_stop(&self) -> zbus::Result<Vec<Exec>>;
